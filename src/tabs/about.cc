...
std::string About::get_marked_up_text() {
  return "<b>What is AppAnvil?</b>\n"
         ...
         "AppArmor is a Linux security module that protects your system from potential threats by imposing Mandatory Access Control "
         "(MAC).\n"
         "It allows the user to secure individual applications by defining and restricting what resources an application can access or "
         "share.\n\n"
         ...
         "<b>How do I add new AppArmor profiles?</b>\n"
         "You can add new AppArmor profiles under the 'Load Profile' tab.\n\n"
         "<b>Where can I find AppArmor profiles to add?</b>\n"
         "Users who are familiar with AppArmor profile creation can create and load their own profiles. Users who are not familiar with\n"
         "AppArmor profile creation should download profiles online that have been tested and verified by trustworthy sources.";
}

std::string About::get_marked_up_text_lower()
{
  std::string text = get_marked_up_text();
